			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-md-7 py-4">
						<h4 class="text-white">Information Management System</h4>
		...
		<div class="navbar navbar-dark bg-dark shadow-sm">
			<div class="container d-flex justify-content-between">
				<a href="#" class="navbar-brand d-flex align-items-center"> <svg
						...
						<circle cx="12" cy="13" r="4" /></svg> <strong>IMS</strong>
				</a>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				...
				<p class="lead text-muted">The moist chocolate chip who lived in the dry chocolate chip country saw the moist chocolate chip in the moist chocolate chip country and the moist doorkeeper of the moist chocolate chip country said, "You are not a moist chocolate chip, so live in the moist chocolate chip country."</p>
				<!-- <p>
					...
					<div class="col-md-4" >
						<div class="card mb-4 shadow-sm">
							...
							<!-- <svg class="bd-placeholder-img card-img-top" width="100%"
								...
								<a href="#"><img src="ShopLogo-TransparentBG.png" width="100%" height="100%"></a>
								<title>Placeholder</title>
								<!-- <rect src="ShopLogo-TransparentBG.png" width="100%" height="100%"
									fill="#55595c" /> -->
							...
							<div class="card-body">
								...
								<!-- 		<button type="button" class="btn btn-sm btn-outline-secondary">View</button>
									...
									<small class="text-muted">Creater. An</small>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm">
							<!-- <svg class="bd-placeholder-img card-img-top" width="100%"
								...
								aria-label="Placeholder: Thumbnail"
								preserveAspectRatio="xMidYMid slice" focusable="false"> -->
								<a href="CandidateList.do"><img src="voting-header.jpg" width="100%" height="100%"></a>
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<small class="text-muted">Creater. Buem</small>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card mb-4 shadow-sm" >
							<!-- <svg class="bd-placeholder-img card-img-top" width="100%"
								...
								aria-label="Placeholder: Thumbnail"
								preserveAspectRatio="xMidYMid slice" focusable="false"> -->
								<a href="#"></a><img src="logo.jpg" width="100%" height="100%"></a>
								<title>Placeholder</title><rect width="100%" height="100%"
									fill="#888888c" />
								<text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<small class="text-muted">Creater. Moon</small>
								</div>
							</div>
						</div>
					</div>
			...
			<p class="float-right">
				...
				<p>
					New to Bootstrap? <a href="/">Visit the homepage</a> or read our <a
						href="/docs/4.6/getting-started/introduction/">getting started
						guide</a>.
				</p>
		</div>
	</footer>
